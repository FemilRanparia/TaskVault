          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              <div className="relative">
                <User className="absolute left-4 top-3.5 w-5 h-5 text-cyan-400/50" />
                <input
                  type="text"
                  required
            ...
            <motion.button
              ...
              disabled={loading}
              type="submit"
              className="w-full mt-6 py-3 rounded-xl bg-gradient-neon hover:opacity-90 transition font-semibold text-white shadow-glow disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
